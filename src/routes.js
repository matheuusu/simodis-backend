...
router.get(
  ...
  UserValidator.recoverPassword,
  UserController.recoverPassword
)
router.put(
  '/user/altpassword',
  UserValidator.altPassword,
  UserController.altPassword
)
router.put(
  '/user/update',
